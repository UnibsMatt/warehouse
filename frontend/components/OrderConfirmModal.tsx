        ...
        <div className="px-6 py-4 border-b border-brand-dark/10 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-brand-dark/50 mt-0.5">
              For <span className="font-medium text-brand-dark">
          ...
          <table className="w-full text-sm">
            <thead className="sticky top-0 bg-brand-cream/90 backdrop-blur-sm">
              <tr className="border-b border-brand-dark/10">
                <th className="px-6 py-3 text-left text-xs font-semibold text-brand-dark/50 uppercase tracking-wide">Product</th>
                <th className="px-6 py-3 text-right text-xs font-semibold text-brand-dark/50 uppercase tracking-wide">Qty</th>
                <th className="px-6 py-3 text-right text-xs font-semibold text-brand-dark/50 uppercase tracking-wide">Unit price</th>
                <th className="px-6 py-3 text-right text-xs font-semibold text-brand-dark/50 uppercase tracking-wide">Discount</th>
                <th className="px-6 py-3 text-right text-xs font-semibold text-brand-dark/50 uppercase tracking-wide">Total</th>
              </tr>
            </thead>
