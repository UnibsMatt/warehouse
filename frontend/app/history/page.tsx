...
function getAppliedDiscount(
  product: { discount_tiers: { min_quantity: number; discount_percent: number }[] },
  quantity: number
): number {
  const tier = product.discount_tiers
    ...
    <div className="min-h-screen bg-brand-cream">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-brand-dark/60 mt-1">All orders — {total} total</p>
        </div>
        ...
        <div className="card p-0 overflow-hidden">
          {orders.length === 0 ? (
            <div className="text-center py-16">
              ...
              <p className="text-brand-dark/50">No orders yet.</p>
            </div>
          ) : (
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-brand-dark/5 border-b border-brand-dark/10">
                    ...
                    <th className="text-right px-4 py-3 font-semibold text-brand-dark/70">Total</th>
                    <th className="text-center px-4 py-3 font-semibold text-brand-dark/70">
                      Status
                    </th>
                  </tr>
                </thead>
