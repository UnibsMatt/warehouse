              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-brand-dark/5 border-b border-brand-dark/10">
                    <th className="text-left px-4 py-3 font-semibold text-brand-dark/70">Order #</th>
                    ...
                    <th className="text-left px-4 py-3 font-semibold text-brand-dark/70">Products</th>
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-1">
                {Array.from({ length: total_pages }, (_, i) => i + 1)
                  ...
                  .map((p, i) =>
                    p === '...' ? (
                      <span key={`ellipsis-${i}`} className="px-2 text-brand-dark/40 text-sm">…</span>
                    ) : (
                      <Link
                        key={p}
                        href={`/history?page=${p}`}
