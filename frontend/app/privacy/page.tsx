        ...
        <div className="space-y-8 text-brand-dark/70 leading-relaxed">
          <section>
            ...
            <p>
              ...
              <strong className="text-brand-dark">Warehouse S.r.l.</strong>, con sede legale in Via
              della Logistica 12, 20100 Milano (MI), P.IVA 01234567890. Per qualsiasi richiesta
              relativa alla privacy puoi contattarci all'indirizzo{' '}
          ...
          <section>
            ...
            <p>Raccogliamo i dati strettamente necessari al funzionamento della piattaforma:</p>
          ...
          <section>
            ...
            <p>
              ...
              lett. b del GDPR), sugli obblighi legali (art. 6, par. 1, lett. c) e, ove applicabile,
              sul legittimo interesse del titolare (art. 6, par. 1, lett. f).
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              successivamente, per il periodo previsto dagli obblighi di legge (di norma 10 anni per
              i dati fiscali). I log di accesso sono conservati per 12 mesi.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              In conformità al GDPR hai diritto di accedere ai tuoi dati, rettificarli, cancellarli,
              limitarne il trattamento, opporti al trattamento e richiederne la portabilità. Per
          ...
          <section>
            ...
            <p>
              ...
              funzionali. Le modifiche rilevanti saranno comunicate via email agli utenti
              registrati.
            </p>
          </section>
        </div>
