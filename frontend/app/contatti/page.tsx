        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <p className="text-brand-dark/70 leading-relaxed">
              Hai domande, suggerimenti o hai bisogno di supporto? Il nostro team è a disposizione
              per aiutarti. Contattaci attraverso uno dei canali qui sotto e ti risponderemo al più
              presto.
            </p>
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={item.label} className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-xs font-medium text-brand-dark/40 uppercase tracking-wide">
                      {item.label}
                    </p>
